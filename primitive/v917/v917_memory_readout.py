...
from v917_fetch_operations import ensure_cid_registered as v915_ensure_cid_registered
# v9.15 段階 2: 50 step 駆動の pulse_fetch は廃止 (event 駆動 Fetch に置換)。
# pulse_fetch 関数自体は v917_fetch_operations.py に残置 (将来の Paired Audit 用)。
