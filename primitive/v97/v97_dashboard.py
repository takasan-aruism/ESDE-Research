...
def run(tag="short"):
    ...
    print(f"\n{'='*70}")
    print(f"  ESDE v9.7 — ERA ANALYSIS ({tag})")
    ...
    # HTML DASHBOARD
    # ════════════════════════════════════════════════════════
    out_html = Path(f"diag_v97_feedback_{tag}") / "dashboard.html"
...
<head>
<meta charset="UTF-8">
<title>ESDE v9.7 Dashboard ({tag})</title>
...
<body>
<h1>ESDE v9.7 Feedback Dashboard — {tag}</h1>
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="ESDE v9.7 Era Analysis + Dashboard")
