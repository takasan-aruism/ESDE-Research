...
_V917_DIR = _REPO_ROOT / "primitive" / "v917"   # v9.17 frozen (Layer B/A obs 継承)
...
from v918_fetch_operations import ensure_cid_registered as v915_ensure_cid_registered
