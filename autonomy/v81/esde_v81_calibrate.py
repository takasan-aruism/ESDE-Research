#!/usr/bin/env python3
"""
ESDE v8.1 — Large-Scale Autonomy Calibration
===============================================
...
-----
  # Single seed
  python esde_v81_calibrate.py --seed 42 --windows 200
...
from esde_v81_engine import V81Engine, V81EncapsulationParams, V81_WINDOW, V81_N
...
def run(seed, n_windows, window_steps, output_dir, encap_params, N,
    ...
    tag = f"v81_N{N}_seed{seed}_{tag_str.replace('+','_')}"
...
def main():
    parser = argparse.ArgumentParser(
        description="ESDE v8.1 Large-Scale Autonomy")
    parser.add_argument("--seed", type=int, default=42)
    parser.add_argument("--windows", type=int, default=200)
    parser.add_argument("--window-steps", type=int, default=V81_WINDOW)
    parser.add_argument("--N", type=int, default=V81_N)
    parser.add_argument("--output", type=str, default="calibration_v81")
    ...
    if args.profile:
        ...
        engine = V81Engine(seed=args.seed, N=args.N, encap_params=params,
