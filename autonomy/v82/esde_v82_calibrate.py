#!/usr/bin/env python3
"""
ESDE v8.2 — Large-Scale Autonomy Calibration
===============================================
...
-----
  # Single seed
  python esde_v82_calibrate.py --seed 42 --windows 200
...
def run(seed, n_windows, window_steps, output_dir, encap_params, N,
    ...
    tag = f"v82_N{N}_seed{seed}_{tag_str.replace('+','_')}"
...
def main():
    parser = argparse.ArgumentParser(
        description="ESDE v8.2 Large-Scale Autonomy")
    ...
    parser.add_argument("--output", type=str, default="calibration_v82")
