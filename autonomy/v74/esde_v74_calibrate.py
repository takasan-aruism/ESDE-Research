#!/usr/bin/env python3
"""
ESDE v7.4 — Large-Scale Autonomy Calibration
===============================================
...
-----
  # Single seed
  python esde_v74_calibrate.py --seed 42 --windows 200
...
from esde_v74_engine import V74Engine, V74EncapsulationParams, V74_WINDOW, V74_N
...
def main():
    parser = argparse.ArgumentParser(
        description="ESDE v7.4 Large-Scale Autonomy")
    parser.add_argument("--seed", type=int, default=42)
    parser.add_argument("--windows", type=int, default=200)
    parser.add_argument("--window-steps", type=int, default=V74_WINDOW)
    parser.add_argument("--N", type=int, default=V74_N)
    parser.add_argument("--output", type=str, default="calibration_v74")
    ...
    if args.profile:
        ...
        engine = V74Engine(seed=args.seed, N=args.N, encap_params=params)
        engine.run_injection()
        pr = cProfile.Profile()
        pr.enable()
        for _ in range(3):
