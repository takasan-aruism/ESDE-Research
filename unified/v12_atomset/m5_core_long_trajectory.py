...
R = 'unified/v12_atomset/run_m5_core_long'; S = range(8); WMAX = 51
...
pd.DataFrame(rows).to_parquet('unified/v12_atomset/traj_out/core_long_ncore2_trajectories.parquet')
