...
- **理論の羅針盤＝`docs/esde_axioms_unified.md`**（公理系統合版 v3.2/v3.3/v3.3.1・2026-07-04）。設計の方向照合・観察の語彙に使う。**判定基準や免罪符にはしない**（公理と経験が衝突したら経験が勝つ）。注意センターの親↔子↔センターは Axiom T（三項創発）の実験系、v1304b「記憶は weight 軌跡に宿る」は準第三項（履歴）と対応。
